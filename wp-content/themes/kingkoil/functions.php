...
add_image_size( 'inner_banner', 1920, 951, true );
add_image_size( 'product_image', 691, 1026, true );
add_image_size( 'about_banner', 1920, 642, true );
add_image_size( 'hospitality_image', 705, 495, true );
add_image_size( 'product_banner', 1920, 642, true );
add_image_size( 'contact_banner', 1920, 642, true );
add_image_size( 'blog_banner', 1920, 642, true );
add_image_size( 'bronze_image', 640, 604, true );
add_image_size( 'gold_image', 639, 424, true );
add_image_size( 'silver_image', 587, 478, true );
add_image_size( 'all_image', 590, 546, true );
//adding custom testimonial
function custom_testimonial_slider() {
   $args = array(
      'label' => 'Testimonial Slider',
        ...
        'hierarchical' => false,
        'rewrite' => array('slug' => 'testimonial_slider'),
        'query_var' => true,
        'supports' => array(
            'title',
            'editor',
...
add_action( 'init', 'custom_testimonial_slider' );


$labels = array(
'name' => __('Products category'),
'singular_name' => __('Products category', 'Products category' ),
'search_items' => __( 'Search Products category' ),
'all_items' => __( 'Products category category' ),
